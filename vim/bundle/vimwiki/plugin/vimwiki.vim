...
let s:vimwiki_defaults.path = '~/Dropbox/vimwiki/wiki'
"let s:vimwiki_defaults.path_html = '~/vimwiki_html/'
let s:vimwiki_defaults.path_html = '~/Dropbox/vimwiki/html/'
...
let s:vimwiki_defaults.template_path = '~/Dropbox/vimwiki/templates/'
